...
Public Module CodesSpecific
    ...
    Dim CodesDefault(0 To 188) As String
    ...
    Public Structure AllCodes
        ...
        'Add for New Rehab SAs
        Public EOVMilling As CodeType
        Public EOVLeveling As CodeType
        Public CrownLeveling As CodeType
        Public CrownMilling As CodeType
        Public EOVMillingInner As CodeType
        Public EOVMillingOuter As CodeType
    End Structure
    ...
    Public Sub FillCodeStructure()
        ...
        With Codes
            ...
            GetFromCollection(colCodesAndDescriptionHashtable, n, .EOVMilling)
            GetFromCollection(colCodesAndDescriptionHashtable, n, .EOVLeveling)
            GetFromCollection(colCodesAndDescriptionHashtable, n, .CrownLeveling)
            GetFromCollection(colCodesAndDescriptionHashtable, n, .CrownMilling)
            GetFromCollection(colCodesAndDescriptionHashtable, n, .EOVMillingInner)
            GetFromCollection(colCodesAndDescriptionHashtable, n, .EOVMillingOuter)
        End With
