...
**Репозиторий под git** с 8 августа 2026: ветка `main`, история начинается
с состояния на эту дату. С 9 августа опубликован на GitHub —
`origin` = https://github.com/monovSi-create/Civil3D_ForRfRW, **публичный**,
лицензия MIT. Подпись коммитов задана локально: `Andrew
<monovSi-create@users.noreply.github.com>` — это скрытый адрес GitHub,
настоящую почту в коммиты не подставлять. Откат доступен —
